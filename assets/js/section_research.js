    ...
    <div class="research-theme">
      <div class="theme-content">
        ...
        <div class="theme-layout">
          <div class="theme-text">
            <p class="theme-description">
              <strong>Challenge:</strong> The Ediacaran Period records both the largest known carbon isotope excursion in Earth history (the Shuram excursion) and the first appearance of complex animal life. Understanding what drove this massive carbon cycle perturbation, how long it lasted, and whether it influenced early animal evolution requires careful integration of geochronology, petrography, and geochemistry. Our work combines new Re–Os age constraints, detailed analysis of carbonate fabrics from the microscale to nanoscale, and multi-isotope systematics to demonstrate that the Shuram represents a relatively short-lived global carbon cycle disturbance beginning near 573 Ma. We suggest the onset coincides with hothouse conditions, followed by environmental stabilization that coincides with deep-water animal diversification.
            </p>
            <div class="related-publications">
              <h4>Recent Publications:</h4>
            <ul>
              <li><b>Wilcots, J.</b>[&#8225;], <b>Bergmann, K.D.</b>[&#8225;], Gilbert, P., Cross, A., 2025, Nanoscale crystal fabric preserved in dolomite ooids at the onset of the Ediacaran Shuram excursion, <em>The Sedimentary Record</em>. <a href="https://thesedimentaryrecord.scholasticahq.com/article/145144-nanoscale-crystal-fabric-preserved-in-dolomite-ooids-at-the-onset-of-the-ediacaran-shuram-excursion">link</a>.</li>
